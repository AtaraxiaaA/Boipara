...
class _BookClubPageState extends State<BookClubPage> with SingleTickerProviderStateMixin {
    ...
    final discussions = [
      {
        'user': 'Rafiq Ahmed',
        'time': '2 hours ago',
        'content': 'Just finished reading "The Midnight Library" by Matt Haig. What an incredible journey through parallel lives! Has anyone else read it?',
        'likes': 24,
        'comments': 8,
      ...
      },
      {
        'user': 'Fatima Khan',
        'time': '5 hours ago',
        'content': 'Looking for recommendations for Bengali literature. Any suggestions for modern Bengali authors?',
        'likes': 18,
        'comments': 12,
        'book': null,
      },
      {
        'user': 'Sakib Hasan',
        'time': '1 day ago',
        'content': 'Our next book club meeting is scheduled for Friday! We\'ll be discussing "Atomic Habits" by James Clear. Don\'t forget to finish the book!',
        'likes': 45,
        'comments': 22,
        'book': 'Atomic Habits',
      },
